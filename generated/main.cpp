...
std::string getTokenTypeName(int type) {
    static std::unordered_map<int, std::string> tokenNames = {
        ...
        {SysyLexer::VOID, "VOID"},
        {SysyLexer::CONST, "CONST"},
        {SysyLexer::RETURN, "RETURN"},
        {SysyLexer::IF, "IF"},
        {SysyLexer::ELSE, "ELSE"},
        {SysyLexer::WHILE, "WHILE"},
        {SysyLexer::BREAK, "BREAK"},
        {SysyLexer::CONTINUE, "CONTINUE"},
        {SysyLexer::LP, "LP"},
        {SysyLexer::RP, "RP"},
        {SysyLexer::LB, "LB"},
        {SysyLexer::RB, "RB"},
        ...
        {SysyLexer::QUESTION, "QUESTION"},
        {SysyLexer::COLON, "COLON"},
        {SysyLexer::MINUS, "MINUS"},
        {SysyLexer::NOT, "NOT"},
        ...
        {SysyLexer::ID, "ID"},
        {SysyLexer::STRING, "STRING"},
        {SysyLexer::LEX_ERR, "LEX_ERR"}
    };
